...
DATA_LIST_PATH = './CCNet/dataset/list/cityscapes/train.lst'
DATA_LIST_PATH = '/home/cheng/workspace/Multi-Scale-Attention_NucleiSegClas-master_0220/CCNet/dataset/list/cityscapes/train.lst'
IGNORE_LABEL = 255
INPUT_SIZE = '769,769'
LEARNING_RATE = 1e-2
MOMENTUM = 0.9
            ...
            for idx in pbar:
                ...
                if global_iteration >= args.num_steps:
                    torch.save(seg_model.state_dict(),
                               osp.join(args.snapshot_dir, 'CS_scenes_' + str(global_iteration) + '.pth'))
                    run = False
                    break    
...
"""
python train.py --data-dir /home/cheng/workspace/Multi-Scale-Attention_NucleiSegClas-master_0220/CCNet/dataset/data --random-mirror --random-scale --restore-from ./dataset/resnet101-imagenet.pth --gpu 0 --learning-rate 1e-2 --input-size 769,769 --weight-decay 1e-4 --batch-size 2 --num-steps 60000 --recurrence 2


python ./CCNet/train.py --data-dir /home/cheng/workspace/Multi-Scale-Attention_NucleiSegClas-master_0220/CCNet/dataset/data --random-mirror --random-scale --restore-from ./CCNet/dataset/resnet101-imagenet.pth --gpu 0 --learning-rate 1e-2 --input-size 224,224 --weight-decay 1e-4 --batch-size 16 --num-steps 10 --recurrence 2
