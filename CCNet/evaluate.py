...
DATA_LIST_PATH = '/home/cheng/workspace/Multi-Scale-Attention_NucleiSegClas-master_0220/CCNet/dataset/list/cityscapes/val.lst'
IGNORE_LABEL = 255
BATCH_SIZE = 4
NUM_CLASSES = 19
...
def main():
    ...
    with Engine(custom_parser=parser) as engine:
        ...
        # print(confusion_matrix.type)
        # pos = confusion_matrix.sum(0)
        # pos = confusion_matrix.sum
...
"""
python ./CCNet/evaluate.py --data-dir /home/cheng/workspace/Multi-Scale-Attention_NucleiSegClas-master_0220/CCNet/dataset/data --restore-from snapshots/CS_scenes_200.pth --gpu 0 --recurrence 2
